...
export PSSH_PATH=/usr/share/pssh
export PATH=$PATH:$PSSH_PATH/bin

export CORK=/usr/bin/corkscrew
export PATH=$PATH:$CORK

export GIT_PROXY_COMMAND=/usr/local/bin/git-proxy
export PATH=$PATH:$GIT_PROXY_COMMAND
